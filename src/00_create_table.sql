...
CREATE TABLE IF NOT EXISTS silver.taxi_silver (
...
COMMENT ON TABLE silver.taxi_silver 
...
CREATE TABLE IF NOT EXISTS gold.taxi_gold (
    vendor_id BIGINT COMMENT 'Identificador do fornecedor do serviço de taxi',
...
COMMENT ON TABLE gold.taxi_gold 
